...
class SetVeiculoVisitTercImplTest : KoinTest {

    private val usecase: SetVeiculoVisitTerc by inject()
    ...
    fun check_return_failure_if_not_have_data_and_flow_change() =
        runTest {
            ...
            assertEquals(
                result.exceptionOrNull()!!.message,
                "Failure Datasource -> MovEquipVisitTercRoomDatasourceImpl.setVeiculo"
            )
        }
    ...
    fun check_return_true_if_set_placa_execute_success_and_flow_add() =
        runTest {
            ...
            assertEquals(entityBefore.veiculoMovEquipVisitTerc, "Teste")
            val result = usecase(
                veiculo = "Teste Veiculo",
                flowApp = FlowApp.ADD,
                id = 0
            ...
            assertEquals(entityAfter.veiculoMovEquipVisitTerc, "Teste Veiculo")
        }
    ...
    fun check_return_true_if_set_placa_execute_success_and_flow_change() =
        runTest {
            ...
            assertEquals(entityBefore.veiculoMovEquipVisitTerc, "VEICULO TESTE")
            val result = usecase(
                veiculo = "Teste Veiculo",
                flowApp = FlowApp.CHANGE,
                id = 1
