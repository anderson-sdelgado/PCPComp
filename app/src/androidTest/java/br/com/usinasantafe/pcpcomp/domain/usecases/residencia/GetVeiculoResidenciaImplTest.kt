...
class GetVeiculoResidenciaImplTest : KoinTest {

    private val usecase: GetVeiculoResidencia by inject()
    ...
    fun check_return_failure_if_not_have_data() =
        runTest {
            ...
            assertEquals(
                ...
                "Failure Repository -> MovEquipResidenciaRepositoryImpl.getVeiculo"
            )
        }
