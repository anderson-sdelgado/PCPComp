...
class GetMotoristaResidenciaImplTest : KoinTest {

    private val usecase: GetMotoristaResidencia by inject()
    ...
    fun check_return_failure_if_not_have_data() =
        runTest {
            ...
            assertEquals(
                ...
                "Failure Repository -> MovEquipResidenciaRepositoryImpl.getMotorista"
            )
        }
