...
class MovVisitTercFlowTest : KoinTest {
    ...
    @Test
    fun mov_visit_terc_flow_terceiro() = runTest {
    ...
    @Test
    fun mov_visit_terc_flow_visitante() = runTest {
        ...
        composeTestRule.onNodeWithText("TIPO").assertIsDisplayed()
        composeTestRule.onNodeWithText("VISITANTE").performClick()
        ...
        composeTestRule.onNodeWithText("NOME DO VISITANTE").assertIsDisplayed()
        composeTestRule.onNodeWithText("OK").performClick()
