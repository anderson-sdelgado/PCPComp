...
class GetMovEquipResidenciaOpenListImplTest : KoinTest {

    private val usecase: GetMovEquipResidenciaOpenList by inject()
    ...
    fun check_return_true_and_data_returned() =
        runTest {
            ...
            assertEquals(list[0].tipoMov, "ENTRADA")
            assertEquals(list[1].tipoMov, "SAIDA")
        }
