...
class GetObservVisitTercImplTest : KoinTest {

    private val usecase: GetObservVisitTerc by inject()
    ...
    fun check_return_failure_if_not_have_data() = runTest {
        ...
        assertEquals(
            ...
            "Failure Repository -> MovEquipVisitTercRepositoryImpl.getObserv"
        )
    }

    @Test
    fun check_return_observ_if_get_observ_execute_success() = runTest {
    ...
    @Test
    fun check_return_null_if_get_observ_execute_success_and_null_observ() = runTest {
        val roomModel = MovEquipVisitTercRoomModel(
            idMovEquipVisitTerc = 1,
            nroMatricVigiaMovEquipVisitTerc = 19759,
            idLocalMovEquipVisitTerc = 1,
