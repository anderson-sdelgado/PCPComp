...
import br.com.usinasantafe.pcpcomp.presenter.config.ConfigState
import br.com.usinasantafe.pcpcomp.presenter.config.ConfigViewModel
import br.com.usinasantafe.pcpcomp.presenter.config.colabList
import br.com.usinasantafe.pcpcomp.presenter.config.sizeUpdateConfig
...
class MatricVigiaViewModelTest {
    ...
    @Test
    fun `check return success in updateAllDatabaseif all update run correctly`() = runTest {
        val checkMatricColab = mock<CheckMatricColab>()
        val setMatricVigiaConfig = mock<SetMatricVigiaConfig>()
        val cleanColab = mock<CleanColab>()
        val recoverColabServer = mock<RecoverColabServer>()
