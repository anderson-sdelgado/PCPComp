...
@Composable
fun MatricColabChaveEquipScreen(
    viewModel: MatricColabChaveEquipViewModel,
    onNavEquip: () -> Unit,
    onNavDetalhe: () -> Unit,
...
@Composable
fun MatricColabChaveEquipContent(
    flowApp: FlowApp,
    matricColab: String,
...
@Composable
fun MatricColabChaveEquipPagePreview() {
    PCPCompTheme {
        Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
            MatricColabChaveEquipContent(
                matricColab = "19759",
